...
const BigDealSection = () => {
  return (
    <div className="flex flex-col bg-[#EEECFB] lg:flex-row items-center justify-center">
      <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
        <div>
          <p className="text-[#6F42C1] italic font-mono">Big Deal</p>
          <p className="text-4xl text-[#1D1D1D] lg:text-5xl">
      ...
      <div>
        <Image src="/image 2.png" alt="Logo" width={390} height={438} />
      </div>
    </div>
  );
};
